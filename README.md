...
(USD 45, EUR 51.5, версія 1.5.5) і з ПДВ 20%. Курс зашитий у вже порахованих
числах, тож при його зміні прайс треба перерахувати заново, а не правити
коефіцієнт у коді.

Оновлення прайсу зіставляє позиції прайсу з каталогом за брендом і назвою —
формулювання виробника в назвах різняться (наприклад, «Sumi Agro» на сайті
проти «Самміт-Агро Юкрейн» у прайсі), тож зіставлення тримає явну відповідність
назв, а не покладається на текстовий збіг. Позиції, для яких прайс не дав
однозначного відповідника (інша упаковка, відсутність у прайсі, партія з
приміткою «прострочений» тощо), лишаються зі старою ціною до уточнення.
