...
тож окремий список лише дублював би плитки. Обрана культура переживає
перемикання вкладок — бренди й категорії в кожній вкладці свої, а культура
та сама.

Щоб додати культуру, допишіть запис у `CROP_FILTERS`. Пункти без жодної
позиції на поточній вкладці в меню не показуються, а категорії, порожні для
обраної культури, ховаються — щоб фільтр не заводив у порожній каталог.
